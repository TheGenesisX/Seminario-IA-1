...
class AGC:
    ...
    def run(self):
        ...
        generacion = 0
#        file = open("C:/Users/qpqpq/Documents/7mo Semestre/Seminario IA 1/Actividad 6/datos_quartic/quartic16_5.txt", "w")
...
#            print("Generación: ", generacion, 'Mejor Histórico: ', self._mejor_historico._cromosoma, -1 * (self._mejor_historico._fitness - self._problema.MAX_VALUE ** self._alelos))
            print("Generación: ", generacion, 'Mejor Histórico: ', self._mejor_historico._cromosoma, -1 * (self._mejor_historico._fitness - ((self._problema.MAX_VALUE ** self._alelos) * 1000000)))
#            if generacion%100 == 0:
#                dato = -1 * (self._mejor_historico._fitness - ((self._problema.MAX_VALUE ** self._alelos) * 1000000))
#                file.write(str(dato) + "\n")
            generacion += 1
#            if(generacion == 2000):
#                file.close()
    ...
    def evaluaIndividuos(self):
        for i in self._individuos:
            ...
            i._fitness += (self._problema.MAX_VALUE ** self._alelos) * 1000000
